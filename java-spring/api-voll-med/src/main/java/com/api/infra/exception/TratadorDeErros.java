...
public class TratadorDeErros {
    ...
    public ResponseEntity<String> tratarErroMensagemInvalida(HttpMessageNotReadableException ex) {
        return ResponseEntity.badRequest().body("Mensagem mal formatada ou corpo ausente");
    }
